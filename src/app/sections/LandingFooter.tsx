...
export default function LandingFooter() {
  ...
  return (
    <footer className={`w-full ${LANDING_MAX_W} mx-auto border-t border-slate-700 pt-16 pb-12 px-4 lg:px-12`}>
      {/* لایه دسکتاپ */}
      <div className="hidden lg:block">
        <div className="flex justify-around items-start gap-12 h-[80%]">
          <div className="flex flex-col items-center">
            ...
            <p className="text-zinc-500 text-xl font-normal font-iranyekan leading-8 max-w-[384px] text-justify">{FOOTER_COPY.desc}</p>
          </div>
          <div className="flex flex-col items-center">
      ...
      <div className="lg:hidden flex flex-col px-2 gap-8 pt-4">
        <div className="flex flex-col text-right">
          ...
          <p className="text-zinc-500 text-sm font-normal font-iranyekan leading-5 max-w-[320px]">{FOOTER_COPY.desc}</p>
        </div>
        <div className="flex flex-col text-right">
